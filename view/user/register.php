        ...
        <?php else: ?>
            ...
            <form action="#" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="name">Вашето име:</label>
                    <div class="col-sm-4">
                        <input type="text" name="name" value="<?php echo $name; ?>" class="form-control" id="email" placeholder="Въведете вашето име">
                    </div>  <span class="error"><?php echo $errorsName ?></span>
                </div>
